...
/* harmony import */ var _conversionUtility__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./conversionUtility */ "./src/conversionUtility.js");
/* harmony import */ var _domHelper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./domHelper */ "./src/domHelper.js");
/* harmony import */ var _weatherFetcher__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./weatherFetcher */ "./src/weatherFetcher.js");
/* harmony import */ var _weatherDom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./weatherDom */ "./src/weatherDom.js");
...
const form = body.appendChild(_domHelper__WEBPACK_IMPORTED_MODULE_4__.default.createElement('form'));
const input = form.appendChild(_domHelper__WEBPACK_IMPORTED_MODULE_4__.default.createElement('input'));
const submit = form.appendChild(_domHelper__WEBPACK_IMPORTED_MODULE_4__.default.createElement('button'));
...
async function doSearch(e) {
  ...
  try {
    const wData = await _weatherFetcher__WEBPACK_IMPORTED_MODULE_5__.default.getWeather(input.value);
    wData._temperatureMode = _conversionUtility__WEBPACK_IMPORTED_MODULE_3__.default.temperatureModes.celsius;

    const wCard = _weatherDom__WEBPACK_IMPORTED_MODULE_6__.default.createBasicCard(wData);
    body.appendChild(wCard);

    const additionalInfo = _weatherDom__WEBPACK_IMPORTED_MODULE_6__.default.createAdditionalInfoCard(wData);
    body.appendChild(additionalInfo);

    const hourlyCard = _weatherDom__WEBPACK_IMPORTED_MODULE_6__.default.createHourlyCard(wData);
    body.appendChild(hourlyCard);

    const weeklyCard = _weatherDom__WEBPACK_IMPORTED_MODULE_6__.default.createWeeklyCard(wData);
